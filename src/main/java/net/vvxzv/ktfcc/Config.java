...
public class Config {
    ...
    private static final ForgeConfigSpec.BooleanValue FOOD_TOOLTIP = BUILDER.comment(" ").comment("Turn on or turn off food tooltips").comment("开启或关闭食物tooltip").define("foodTooltips", true);
